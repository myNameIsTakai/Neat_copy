            ...
            <div class="card-body" style="padding:30px;">
                ...
                <div class="row mt-5">
                    ...
                    <div class="custom-control custom-radio custom-control-inline mt-auto mb-auto">
                        <input type="radio" class="custom-control-input" id="customRadio1" name="Studio">
                        <label class="custom-control-label" for="customRadio1">Studio</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline mt-auto mb-auto">
                        <input type="radio" class="custom-control-input" id="customRadio2" name="Apartment">
                        <label class="custom-control-label" for="customRadio2">Apartment</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline mt-auto mb-auto">
                        <input type="radio" class="custom-control-input" id="customRadio3" name="House">
                        <label class="custom-control-label" for="customRadio3">House</label>
                    </div>
                </div>
                <hr>
                            ...
                            <div class="col-md-4 mx-auto">
                                <div style="border: 1px solid #ddd; border-radius:5%; height:97%; width:110%;">
                                    <div class="row">
                                        ...
                                        <input type="checkbox" id="check3" name="check3" style="margin-left: -2%; margin-top:4%; width:2.5vw; height:2.5vh;">
                            ...
                            <div class="col-md-4 mx-auto">
                                <div style="border: 1px solid #ddd; border-radius:5%; height:97%; width:110%;">
                                    <div class="row">
                                        ...
                                        <input type="checkbox" id="check4" name="check4" style="margin-left: 2%; margin-top:4%; width:2.5vw; height:2.5vh;">
